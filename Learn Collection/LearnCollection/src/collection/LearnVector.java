...
public class LearnVector {
	...
	private static Vector<Employee> empList = new Vector<Employee> ();
	...
	public static void main(String[] args) {
		...
		empList.add(e1);
		empList.addElement(e2);
		empList.add(e3);
		empList.add(e4);
		//System.out.println(empList.capacity());
		System.out.println(empList.indexOf(e4));
		empList.removeElementAt(0);
		System.out.println(empList.indexOf(e4));
	}
